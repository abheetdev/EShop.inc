...
if(isset($_COOKIE['item'])){
	foreach ($_COOKIE['item'] as $name1 => $value) {
		if(isset($_POST["delete$name1"])){
			echo "chal raha hai re baba";
			setcookie("item[$name1]","",time()-1800);
?>

<script type="text/javascript">
	window.Location.href = window.Location.href;    //reloads the current page without the POST data. 
</script>
	...
	<section id="cart_items">
		<div class="container">
			...
			<div class="table-responsive cart_info">
				...
				<p style="float: right; font: 20px bold red; padding-right: 100px;"><?php echo "TOTAL:".$tot; $_SESSION['pay']=$tot; ?></p>;
				
				<center>
					<a href="checkout.php">
					<input type="button" name="button2" value="checkout">
					</a>
				</center>
