...
if(isset($_POST["submit1"])){
	...
	// to get item description form the table
		...
		foreach ($_COOKIE['item'] as $name1 => $value) {
			...
			if($img1 == $values11[0]){
				...
				while($row4=mysqli_fetch_array($res)){
					$tb_qty=$row4["product_qty"];
				}

				if($tb_qty<$qty){
					?>
					<script type="text/javascript">
					alert("this is much quantity not available");
					</script>
			...
			setcookie("item[$name1]",$img1."__".$nm."__".$price."__".$qty."__".$total, time()+1800);	// $name1=current cookie position
					}
			}
		}
					...
					<div class="product-details"><!--product-details-->
						<div class="col-sm-5">
							<div class="view-product">
								...
								<img src="../admin/<?php echo $row['product_image']; ?>" alt="not found" />   
								<h3>ZOOM</h3>
							</div>
