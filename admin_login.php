...
<html >
  ...
  <form class="login-container" name="form1" action="" method="post">
    <p><input type="text" placeholder="Email" name="username" required></p>
    ...
    if(isset($_POST["submit1"])){
      $res = mysqli_query($link,"select * from admin_login where username='$_POST[username]' and password='$_POST[pwd]'");
